      ...
      >
        ...
        >
          ...
          <div className="nav-actions">
            <a href={`${import.meta.env.BASE_URL}docs/Resume.pdf`} target="_blank" rel="noopener noreferrer" className="btn-primary desktop-only" style={{ padding: '8px 20px', fontSize: '0.9rem', borderRadius: '10px' }}>
              Resume
            </a>
        ...
        {isOpen && (
          ...
          >
            <ul className="mobile-nav-links">
              ...
              <li>
                <a href={`${import.meta.env.BASE_URL}docs/Resume.pdf`} target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ display: 'flex', justifyContent: 'center', marginTop: '10px' }} onClick={() => setIsOpen(false)}>
                  Resume
                </a>
              </li>
            </ul>
