...
import { MAXIMUM_NAME_LENGTH, MAXIMUM_MESSAGE_LENGTH, MAXIMUM_EMAIL_LENGTH } from '../utils/contactForm';
...
const FloatingInput = ({
  ...
  const inputProps = isTextArea ? { rows: 5, maxLength } : { type, maxLength };
